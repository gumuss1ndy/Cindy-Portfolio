  ...
  },
{
    ...
    responsibilities: [
      'Assisted in the development and debugging of web applications built with Angular and Laravel, ensuring seamless integration between the frontend and RESTful APIs.',
      'Identified and resolved UI/UX bugs in Angular components to maintain design consistency and improve user engagement.',
      'Utilized Postman to test and validate Laravel API endpoints, ensuring data integrity and proper server-side functionality.',
      'Collaborated with the development team via Git and Jira to manage feature updates and hotfixes within the codebase.',
      'Performed regression testing on new Laravel deployments to verify stability and prevent breaking changes in production.',
    ],
    skills: [
      { name: 'Angular' },
      { name: 'Laravel' },
